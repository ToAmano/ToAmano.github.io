...
| 調整部位 | 袖口ドローコード，チンガードドローコード，フードドローコード                           | 袖口ドローコード，チンガードドローコード，フードドローコード                                                                     |
...
フードはいつものアークテリクス仕様でヘルメット対応なので大きいのだが，フード部分の後ろ側にもドローコードがついており，フードの調整が可能だ．

{% include figure popup=true image_path="/assets/posts/2025-12-27-arcteryx-gamma-mx-review/DSC_0314.jpg" alt="" caption="" %}

チンガードはかなりしっかりしていて首元の風はかなり防げる．内側にはドローコードがついていてチンガードを調整できる．ただし，内側に配置してしまったために非常に操作しにくくなっており，別途紹介するベータSLのように外側に配置してくれていれば．．．と思ってしまう．
