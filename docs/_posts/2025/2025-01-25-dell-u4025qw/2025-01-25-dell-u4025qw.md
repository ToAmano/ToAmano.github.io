...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_0029.jpg" alt="ディスプレイをデスクに設置したところ" caption="デスクに設置するとその大きさを実感する．" %}
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_0030.jpg" alt="ディスプレイをデスクに設置したところ" caption="左がEX3240X,右がU4025QW." %}

モニターを横から見ると緩やかに湾曲しているのが見て取れる．

{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_2025.jpg" alt="ディスプレイを横から見たところ" caption="" %}
...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_0037.jpg" alt="背面ボタン" caption="" %}

設定は入出力をはじめ，色味や音量など多岐にわたる．大メニューとしてInput Source, Preset Modes, AutoBrightness, Display Infoの4つがあり，それぞれに小項目がたくさんある．Input Sourceは主に入出力関連の設定，Preset Modesは色味の設定，AutoBrightnessは輝度の自動調節でDisplay Infoはディスプレイ情報を表示する．

{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_0047.jpg" alt="物理ボタンによる操作画面" caption="" %}
...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/DSC_0017.jpg" alt="背面ボタン" caption="" %}
...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/2025-01-25_231246_.png" alt="背面ボタン" caption="" %}
...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/2025-01-25_232257_.png" alt="背面ボタン" caption="" %}
...
{% include figure popup=true image_path="/assets/posts/2025/2025-01-25-dell-u4025qw/figures/2025-01-25_234650_.png" alt="背面ボタン" caption="" %}
